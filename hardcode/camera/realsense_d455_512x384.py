...
class RealSense_D455:
    def __init__(self, WH=[640, 480], depth_threshold=[0, 2], serial_number="239222303321"):
    ...
    def get_observations(self):
        ...
        point = points[:384, 64:576]
        color = colors[:384, 64:576]
        depth = depths[:384, 64:576]
        mask = mask[:384, 64:576]        

        return point, color, depth, mask
